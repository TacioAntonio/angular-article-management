...
describe('FormValidationsComponent', () => {
  ...
  it('should perform the hasErrors and return true', () => {
    ...
    component.field.setValue(''); // Define um valor inválido
    component.field.markAsDirty(); // Marca o campo como sujo
    component.field.markAsTouched(); // Marca o campo como tocado
